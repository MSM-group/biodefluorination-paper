...
# Load alignment file
seqs <- read.alignment("data/Machine_learning/validation/2447_mutlib_all_seqs_aligned.fasta", format = "fasta") 
lb_rham<-seqs$seq[[1]] 
seqs$nam
...
dat_test <- bind_rows(dat_test0, dat[51:2403,])
...
saveRDS(rf, "data/Machine_learning/2447_classification_random_forest_no_Ascan.rds")
...
write_csv(see_preds, "data/machine_learning/validation/2447_predictions_no_Ascan_50.csv")
