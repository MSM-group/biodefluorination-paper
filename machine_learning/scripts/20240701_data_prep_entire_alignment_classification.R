...
write_csv(rawdat, 'data/machine_learning/20240701_defluorinases_entire_alignment_for_classification.csv')
...
saveRDS(rf, "data/Machine_learning/20240701_classification_random_forest.rds")
