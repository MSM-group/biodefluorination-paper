...
dat_split <- rsample::initial_split(dat[1:401,], prop = 0.99, strata = "truth")
dat_split
dat_train <- rsample::training(dat_split)
dat_test0 <- rsample::testing(dat_split)
dat_test <- bind_rows(dat_test0, dat[402:2403,])
...
saveRDS(rf, "data/Machine_learning/2447_classification_random_forest.rds")
...
write_csv(see_preds, "data/machine_learning/validation/2447_predictions.csv")
