...
# Read in the dataset
reg_df <- read_csv('data/machine_learning/20240629_defluorinases_C_term_for_classification.csv')
...
rf_20200629 <- readRDS("data/machine_learning/20240629_C_term_classification_random_forest.rds")
...
write_tsv(traindf,"data/machine_learning/20240629_C_terminal_mean_training_accuracy_1000_test_train_splits.txt")
...
write_tsv(tibble(mean_testing_vec),"data/machine_learning/20240629_C_terminal_classification_mean_testing_accuracy_1000_test_train_splits.txt")
...
write_csv(allsumm, "data/machine_learning/20240629_C_terminal_classification_train_test_1000_summaries.csv")
...
pdf("data/machine_learning/20240629_C_terminal_1000_binary_classification_training_testing_split_hist.pdf", width = 7, height = 4)
...
dat_df
write_csv(dat_df, "data/Machine_learning/20240629_C_terminal_classification_accuracy_1000_training_test_combined.csv")
colMeans(dat_df)
